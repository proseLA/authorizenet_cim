<?php
	/*  portions copyright by... zen-cart.com
	   ...
	   04/2021  project: authorizenet_cim; file: class.cim_admin_observer.php; version 2.3.1
	*/
		...
		public function update(&$class, $eventID, &$p1, &$p2, &$p3, &$p4)
		{
			switch ($eventID) {
				...
				case 'NOTIFY_ADMIN_CUSTOMERS_MENU_BUTTONS':
					...
					require_once DIR_FS_ADMIN . DIR_WS_LANGUAGES . $_SESSION['language'] . '/authnet_order.php';
