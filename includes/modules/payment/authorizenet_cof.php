<?php
     ...
     *
     *  03/2024  project: authorizenet_cim v3.0.0 file: authorizenet_cof.php
     */
    ...
    class authorizenet_cof extends authorizenet_cim
    {
        ...
        function __construct()
        {
            ...
            $this->enabled = MODULE_PAYMENT_AUTHORIZENET_CIM_STATUS == 'True';
            if ($this->enabled) {
        ...
        function selection(): false|array
        {
            ...
            $all = false;
            if ((isset($_SESSION['emp_admin_login']) && $_SESSION['emp_admin_login'])) {
                $all = true;
            }
