<?php
    ...
    include(DIR_WS_MODULES . 'payment/authorizenet_cim.php');
    ...
    $addresses_query = "SELECT address_book_id, entry_firstname as firstname, entry_lastname as lastname,
                      entry_company as company, entry_street_address as street_address, entry_suburb as suburb, entry_city as city, entry_postcode as postcode,
                      entry_sh_phone as sh_phone, entry_state as state, entry_zone_id as zone_id, entry_country_id as country_id
