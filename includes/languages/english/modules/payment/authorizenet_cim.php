<?php
   ...
   04/2020  project: authorizenet_cim; file: authorizenet_cim.php
   */
    ...
    define('MODULE_PAYMENT_AUTHORIZENET_CIM_TEXT_TRANS_ID_REQUIRED_ERROR',
      'Error: You need to specify a Transaction ID.');
